...
#if !defined(__DragonFly__) && !defined(__OpenBSD__) && !defined(__NetBSD__) && !defined(__APPLE__) && !defined(_WIN32) && !defined(__CYGWIN__) && !defined(__sun) && !defined(__GNU__) && !defined(FreeBSD_kernel__)
#define HAS_IP_MREQN
#endif
            ...
            const char * descURL, unsigned int scope_id)
{
  ...
  /* get deescription of WANIPConnection */
