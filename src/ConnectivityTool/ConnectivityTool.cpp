...
namespace {
  ...
  const command_line::arg_descriptor<std::string> arg_get_daemon_info    = {"rpc_get_daemon_info", "request daemon state info vie rpc (--rpc_port option should be set ).", "", true};
}
