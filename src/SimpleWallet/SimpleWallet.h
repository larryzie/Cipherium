...
namespace CryptoNote
{
  ...
  private:
    ...
    bool print_private_keys(const std::vector<std::string> &args = std::vector<std::string>());
    bool vanity_key_gen(const std::vector<std::string> &args = std::vector<std::string>());
